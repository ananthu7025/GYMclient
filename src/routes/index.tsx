...
import FranchisePayment from "../pages/SuperAdmin/Payment";
import MemberPayments from "../pages/Gym/PaymentsMembers";
import GymDashboard from "../pages/Gym/Dashboard";
import FranchiseDashboard from "../pages/Franchises/Dashboard";
...
export const routes: Route[] = [
  ...
  },
  {
    ...
    element: <FranchisePayment />,
    protected: true,
    layout: true,
  },
  {
    path: "/gyms-admin/payments",
